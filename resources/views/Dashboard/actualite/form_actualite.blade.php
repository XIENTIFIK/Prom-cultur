        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <h3 class="page-header">
              <i class="fa fa-files-o"></i>Enregstrer une actualité</h3>
            <ol class="breadcrumb">
        ...
        <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              Enregstrer une actualité
              </header>
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" enctype="multipart/form-data"  action="{{route('enregistrer_actualite')}}"  method="POST">
                  @csrf
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control " id="text" type="text" name="contenu" required />
                      </div>
                    </div>
                    <div class="form-group ">
