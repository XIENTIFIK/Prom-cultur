      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href=" {{route('acteur_liste')}}">Liste des acteurs</a></li>
              <li><a class="" href=" {{route('actualite_liste')}}">Liste des actualites</a></li>
              <li><a class="" href=" {{route('spectacle_liste')}}">Liste des spectacles</a></li>
            </ul>
          </li>
